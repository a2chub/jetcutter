...
from jetcutter.exporters.base import (
...
from jetcutter.exporters.factory import ExporterRegistry, create_exporter
...
def _register_exporters() -> None:
    ...
    try:
        from jetcutter.fcp.exporter import FCPExporter
