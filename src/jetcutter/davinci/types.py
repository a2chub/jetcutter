...
Usage:
    from jetcutter.davinci.types import DRTimeline, DRProject
...
DRProject = Any
"""Project object (note: different from jetcutter.davinci.project.DRProject class)"""

DRMediaPool = Any
"""Media pool object (note: different from jetcutter.davinci.media_pool.DRMediaPool class)"""
